...
(defun my/denote-menu-filter-custom ()
  (let ((my-matching-denote-paths (do-some-filtering-of-tabulated-list-entries-blah-blah)))
    (setq tabulated-list-entries (lambda () (mapcar #'denote-menu--path-to-entry my-matching-denote-files)))
    (revert-buffer)))
